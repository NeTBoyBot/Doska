...
namespace Doska.Migrations.Migrations
{
    ...
    [Migration("20230307082447_Delete_Sub_Categories")]
    partial class Delete_Sub_Categories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Doska.Domain.Category", b =>
                {
                    ...
                    b.Property<Guid?>("ParenCategoryId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("ParenCategoryId");
            ...
            modelBuilder.Entity("Doska.Domain.Ad", b =>
                {
                    b.HasOne("Doska.Domain.Category", "Subcategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Doska.Domain.Category", b =>
                {
                    b.HasOne("Doska.Domain.Category", "ParenCategory")
